...
setup(
    ...
    download_url='https://github.com/sadrasabouri/pyrandwalk/tarball/v0.1',
    ...
    classifiers=[
        ...
        'Topic :: Scientific/Engineering :: Stochastic Processes',
        'Topic :: Education',
        'Topic :: Scientific/Engineering',
        'Topic :: Scientific/Engineering :: Random Walks',
